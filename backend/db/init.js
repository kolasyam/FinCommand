...
const LEDGER_MASTER_SEED = [
  ...
  ['5031','Advance from Customers',10,'Other Current Liabilities','lc',null,'Cr'],
  ['5032','Statutory Dues Payable (PF, ESIC)',10,'Other Current Liabilities','lc',null,'Cr'],
  ['5033','TDS Payable',10,'Other Current Liabilities','lc',null,'Cr'],
  ['5034','GST Payable',10,'Other Current Liabilities','lc',null,'Cr'],
  ['5035','Current Tax Payable',10,'Other Current Liabilities','lc',null,'Cr'],
  // Revenue
...
async function init() {
  ...
  try {
    ...
    console.log('   Run: node db/seed.js to create a demo company + admin user');
  } catch (err) {
